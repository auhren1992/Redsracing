...
Latest mobile release on `main` (when this doc was added): **11.2.25 (211)** — on-screen Update available banner; homepage Enable Notifications works reliably in Android/iOS app WebViews (FCM race/schedule topics).
