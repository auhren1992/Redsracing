...
(async function initJonsK1Stats() {
  const root = document.getElementById('jons-k1-stats');
  if (!root) return;
  ...
  async function loadK1Data() {
    try {
      const response = await fetch('./data/jons-k1-addison-history.json', { 
        cache: 'no-store',
        headers: {
      ...
      const backupData = localStorage.getItem('jons-k1-backup');
      if (backupData) {
      ...
      localStorage.setItem('jons-k1-backup', JSON.stringify(data));
      return data;
    } catch (error) {
      ...
      seasons: [
        {
          ...
          averageLap: "30.123",
          topFinishes: 3,
          summary: "Elite Performance: Jon Kirsch is having an outstanding 2025 season at K1 Speed Addison, currently sitting in 2nd place in the Adult League championship standings. With 160 points across 8 Grand Prix events, he's established himself as a consistent front-runner."
        },
        {
          year: 2024,
          ...
          averageLap: "30.789",
          topFinishes: 2,
          summary: "Building Momentum: Jon's 2024 season at K1 Speed Addison was a solid foundation year, finishing 5th in the championship with 142 points. This season provided valuable experience in indoor karting competition and set the stage for his impressive 2025 championship run."
        },
        {
          year: 2023,
          status: "Debut Season",
          ...
          averageLap: "31.456",
          topFinishes: 1,
          summary: "Racing Genesis: Jon's 2023 debut season at K1 Speed Addison marked the beginning of his indoor karting journey. Finishing 8th with 89 points, this rookie campaign provided the foundation for everything that followed. The skills, racecraft, and competitive spirit developed during this first season have been instrumental in his progression to championship contention and his success in stock car racing."
        }
      ],
      careerStats: {
        totalRaces: 30,
      ...
      <div class="p-6">
        ...
        <div class="text-center">
          <p class="text-slate-300 text-sm leading-relaxed">
            ...
            From rookie to championship contender, Jon's K1 Speed progression tells the story of dedication and improvement. 
    ...
    try {
      ...
      if (isAdmin) {
        ...
        controls.innerHTML = `
          ...
          <div class="text-slate-400 text-xs">Jon's complete K1 Speed Addison racing history with backup persistence</div>
        `;
  ...
  window.updateJonsK1Data = async function(newData) {
    if (!isAdmin) {
    ...
    try {
      ...
      localStorage.setItem('jons-k1-backup', JSON.stringify(newData));
  ...
  window.exportJonsK1Data = function() {
    const backup = localStorage.getItem('jons-k1-backup');
    if (backup) {
