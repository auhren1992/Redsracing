...
class LoginPageController {
    ...
    async initialize() {
        try {
            // Expose a status flag early
            window.__loginReady = false;
            ...
            // Expose helpers for debugging/fallbacks
            window.__loginReady = true;
            window.__forceSignIn = () => this.handleEmailSignIn();
    ...
    bindEvents() {
        ...
        // Also handle Enter/submit on the form
