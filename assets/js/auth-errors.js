...
const AUTH_ERROR_MESSAGES = {
    ...
    'auth/too-many-requests': 'Too many failed login attempts. Please wait a moment and try again.',
    'auth/network-request-failed': 'Network error. Please check your internet connection and try again.',
    'auth/timeout': 'Request timed out. Please try again.',
    
    // Multi-Factor Authentication Errors
    'auth/multi-factor-required': 'Multi-factor authentication is required for this account.',
    'auth/multi-factor-info-not-found': 'Multi-factor authentication information not found.',
    'auth/multi-factor-auth-required': 'Additional authentication is required to complete sign-in.',
    'auth/invalid-multi-factor-session': 'Multi-factor authentication session has expired. Please try again.',
    'auth/maximum-second-factor-count-exceeded': 'Maximum number of second factors exceeded for this user.',
    'auth/second-factor-already-in-use': 'This second factor is already registered for this account.',
    ...
    'auth/invalid-phone-number': 'Please enter a valid phone number with country code (e.g., +1 555-555-5555).',
    'auth/missing-phone-number': 'Please enter a phone number.',
    'auth/quota-exceeded': 'SMS quota exceeded. Please try again later.',
    'auth/invalid-verification-code': 'Invalid verification code. Please check the code and try again.',
    'auth/invalid-verification-id': 'Verification session has expired. Please request a new code.',
    'auth/missing-verification-code': 'Please enter the verification code.',
    'auth/missing-verification-id': 'Verification session not found. Please request a new code.',
    'auth/code-expired': 'Verification code has expired. Please request a new code.',
    'auth/captcha-check-failed': 'reCAPTCHA verification failed. Please try again.',
    'auth/missing-app-credential': 'Phone authentication configuration error. Please contact support.',
    
    // Google Sign-In Errors
    'auth/popup-blocked': 'Sign-in popup was blocked by your browser. Please allow popups and try again.',
    'auth/popup-closed-by-user': 'Sign-in cancelled. Please try again if you want to sign in.',
    ...
    'auth/account-exists-with-different-credential': 'An account already exists with the same email but different sign-in method. Please try signing in with your original method.',
    ...
    'auth/argument-error': 'Authentication configuration error. Please contact support.',
    ...
    'auth/web-storage-unsupported': 'Your browser does not support local storage required for authentication.',
...
export function getFriendlyAuthError(error) {
    ...
    console.warn(`[Auth Errors] Unmapped error code: ${errorCode}, message: ${error?.message}`);
